...
function check(){ // Verifica se o jogo terminou
	...
	if (
	   (casas[0].src == casas[1].src && casas[0].src == casas[2].src && casas[0].src != aux.src) 
	|| (casas[0].src == casas[3].src && casas[0].src == casas[6].src && casas[0].src != aux.src)
	|| (casas[0].src == casas[4].src && casas[0].src == casas[8].src && casas[0].src != aux.src)
	|| (casas[2].src == casas[4].src && casas[2].src == casas[6].src && casas[2].src != aux.src)
	|| (casas[1].src == casas[4].src && casas[1].src == casas[7].src && casas[1].src != aux.src)
	|| (casas[3].src == casas[4].src && casas[3].src == casas[5].src && casas[3].src != aux.src)
	|| (casas[6].src == casas[7].src && casas[6].src == casas[8].src && casas[6].src != aux.src)
	|| (casas[2].src == casas[5].src && casas[2].src == casas[8].src && casas[2].src != aux.src)
		){
